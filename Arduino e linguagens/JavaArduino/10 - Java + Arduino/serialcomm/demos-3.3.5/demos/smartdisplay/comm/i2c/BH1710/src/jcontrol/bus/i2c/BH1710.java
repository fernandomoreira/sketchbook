...
public class BH1710 extends I2C {
	...
	public static void main(String args[]) throws IOException {
		...
		console.println("Initialize BH1710 sensor");
		try { ThreadExt.sleep(1000); } catch (Exception e) {}
		BH1710 sensor = new BH1710(0x46);
		for (;;) {
			try { ThreadExt.sleep(100); } catch (Exception e) {}
			int v = sensor.getContinuouslyMeasurementL();
			console.println("lux: ".concat(String.valueOf(v)));
			// measurements: 1,2mm * 1,5mm = 0,0012m * 0,0015m = 0,0000018 m²
			// pi * thumb = 0,26*lux ~= lumen ?
			//v = Math.scale(v, 100, 26);
			//console.println("lumen: ".concat(String.valueOf(v)));
		}
	}
