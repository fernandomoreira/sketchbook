...
public class FrameTela extends JFrame {
	...
	private String [] mensagem = {"OL� JAVA", "CAF� com java"};
	...
	private void criaPainel(){
		...
		painel.setBorder(BorderFactory.createTitledBorder("Exemplo comunica��o com Arduino"));
		add(painel);
		...
		painel.add(btnLeft);
		btnFecharConexao = new JButton("Fechar Conex�o");
