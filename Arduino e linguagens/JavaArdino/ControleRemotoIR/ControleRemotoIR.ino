//---------------------------------------------------------------------------------------------------
  ...
  void setup()
  {
    ...
    pinMode(ledPin2, OUTPUT);  //Configurando o pino como saida
    pinMode(ledPin3, OUTPUT);  //Configurando o pino como saida
    pinMode(ledPin4, OUTPUT);  //Configurando o pino como saida 
